...
const material = new THREE.MeshStandardMaterial({color : 0x1d0a2b})
...
function moveCamera(){
  ...
  camera.position.z = currPos * -0.01;
  camera.position.x = currPos * -0.0002;
  camera.rotation.y = currPos * -0.0002;
}
